...
export default function PricingSection() {
  ...
  return (
    <section id="pricing" style={{ padding: mob ? '80px 20px' : '100px 24px', background: t.bg }}>
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>

        {/* Heading */}
        <div style={{ textAlign: 'center', marginBottom: 60 }}>
          <h2 style={{ fontSize: mob ? 32 : 48, fontWeight: 900, color: t.text, margin: '0 0 16px', letterSpacing: '-1px' }}>
            Choose your <span className="gt">plan</span>
          </h2>
          <p style={{ fontSize: mob ? 15 : 17, color: t.textMuted, margin: 0 }}>
          ...
          {PLANS.map((plan) => {
            ...
            return (
              <div key={plan.id} style={{
                ...
                position: 'relative',
                transform: isPopular && !mob ? 'translateY(-12px)' : 'none',
              }}>
                {isPopular && (
                  <div style={{
        ...
        <p style={{ textAlign: 'center', fontSize: 13, color: t.textMuted, marginTop: 48 }}>
